    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 mt-3">
                <p><i class="fa fa-envelope mr-3"></i>mehakbaid98@gmail.com</p>
            </div>
            <!-- 3 md end -->
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item mt-2">
          ...
          <li class="nav-item active mt-2">
            <a class="nav-link" href="buymedicine.html"><b>Purchase Medicine</b> &nbsp; &nbsp; &nbsp;  <span class="sr-only">(current)</span> </a>
          </li>
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-sm-4 mt-5 mb-5">
      <div class="card ca1" >
        ...
        <img src="images/panadol.jpeg" height="300" class="card-img-top" alt="no">
